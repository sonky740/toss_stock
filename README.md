...
<p align="center">
  <img src="assets/readme.png" alt="tossstock 메뉴바 앱 — 보유종목·관심종목 팝업" width="360">
</p>
...
코드를 고친 뒤 **재빌드 → 실행 중 인스턴스 종료 → `/Applications` 재실행**을 한 명령어로 처리한다:
...
- 최초 실행 시 관심종목은 **비어 있다**(기본 시드 없음). 아래 패널에서 추가하거나 파일을 직접 만든다.
